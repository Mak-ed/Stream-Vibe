  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxs("svg", { className: "burger-button__svg", width: "30", height: "30", viewBox: "0 0 100 100", children: [
        /* @__PURE__ */ jsx("path", { className: "burger-button__line burger-button__line--1", d: "M 20,29.000046 H 80.000231 C 80.000231,29.000046 94.498839,28.817352 94.532987,66.711331 94.543142,77.980673 90.966081,81.670246 85.259173,81.668997 79.552261,81.667751 75.000211,74.999942 75.000211,74.999942 L 25.000021,25.000058" }),
        /* @__PURE__ */ jsx("path", { className: "burger-button__line burger-button__line--2", d: "M 20,50 H 80" }),
        /* @__PURE__ */ jsx("path", { className: "burger-button__line burger-button__line--3", d: "M 20,70.999954 H 80.000231 C 80.000231,70.999954 94.498839,71.182648 94.532987,33.288669 94.543142,22.019327 90.966081,18.329754 85.259173,18.331003 79.552261,18.332249 75.000211,25.000058 75.000211,25.000058 L 25.000021,74.999942" })
      ] })
    }
  );
};
...
const Footer = () => {
  ...
  return /* @__PURE__ */ jsx("footer", { className: "footer", children: /* @__PURE__ */ jsxs("div", { className: "footer__inner container", children: [
    /* @__PURE__ */ jsx("nav", { className: "footer__menu", children: menuItems.map(({ title, links, socialLinks }, index2) => /* @__PURE__ */ jsxs("div", { className: "footer__menu-column", children: [
      ...
      (socialLinks == null ? void 0 : socialLinks.length) > 0 && /* @__PURE__ */ jsx(
        Socials,
        {
      ...
      children: [
        /* @__PURE__ */ jsxs("header", { className: "section__header", children: [
          /* @__PURE__ */ jsxs("div", { className: "section__info", children: [
            ...
            description && /* @__PURE__ */ jsx("div", { className: "section-description", children: /* @__PURE__ */ jsx("p", { children: description }) })
          ] }),
  ...
  return /* @__PURE__ */ jsx(
    Section,
    {
      ...
      children: /* @__PURE__ */ jsx(
        ...
        {
          columns: 3,
          children: deviceItems.map((deviceItem, index2) => /* @__PURE__ */ createElement(DeviceCard, { ...deviceItem, key: index2 }))
        }
      )
    }
  );
            ...
            children: /* @__PURE__ */ jsx("summary", { className: "accordion__summary", children: /* @__PURE__ */ jsxs(
              "h3",
              {
                ...
                children: [
                  ...
                  isArrowButton && /* @__PURE__ */ jsx("div", { className: "accordion__arrow", children: /* @__PURE__ */ jsx(
                    Icon,
                    {
                      name: "arrow-down"
                    }
...
const Questions = () => {
  ...
  return /* @__PURE__ */ jsx(
    Section,
    {
      ...
      children: /* @__PURE__ */ jsx(AccordionGroup, { columns: 2, children: questionsItem.map((question, index2) => /* @__PURE__ */ jsx(
        Accordion,
        {
          title: question,
          id: `question-${index2}`,
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "tabs__body", children: items.map((item, index2) => {
          ...
          const {
            buttonId,
            contentId
          } = getTabsElementsIdsFromTitle(title2);
          return /* @__PURE__ */ jsx(
            "div",
            {
...
const MovieBannerCard = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "movie-banner-card", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: classNames("movie-banner-card__inner", {
...
const Tags = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      className: "tags",
      children: /* @__PURE__ */ jsx("ul", { className: "tags__list", children: items.map((tag, index2) => /* @__PURE__ */ jsx("li", { className: "tags__item", children: tag }, index2)) })
    }
  );
};
const Ratings$1 = "";
const Ratings = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      className: "ratings",
      children: /* @__PURE__ */ jsx("ul", { className: "ratings__list", children: items.map(({ title, ratingValue }, index2) => /* @__PURE__ */ jsxs("li", { className: "ratings__item", children: [
    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "movie-details__main", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "movie-details__panel ", children: [
            /* @__PURE__ */ jsxs("header", { className: "movie-details__panel-header movie-details__panel--large-gap-y", children: [
        ...
        /* @__PURE__ */ jsx("aside", { className: "movie-details__info", children: /* @__PURE__ */ jsx("div", { className: "movie-details__panel", children: /* @__PURE__ */ jsxs("div", { className: "movie-details__groups", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "movie-details__group", children: [
            /* @__PURE__ */ jsxs("h3", { className: "movie-details__title", children: [
              ...
              /* @__PURE__ */ jsx("span", { children: "Genres" })
            ] }),
            /* @__PURE__ */ jsx(
              Tags,
              {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          Slider,
          {
            ...
            children: movieCards.map((movieCard, index2) => /* @__PURE__ */ createElement(
              MovieBannerCard,
              {
                ...movieCard,
                key: index2
    ...
    "a",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "movie-card__body", children: [
          ...
          rating && /* @__PURE__ */ jsx(Badge, { className: "movie-card__rating-badge", children: /* @__PURE__ */ jsx(RatingView, { ...rating }) }),
          views && /* @__PURE__ */ jsx(
            Badge,
            {
              iconName: "eye",
              ...
              Section,
              {
                ...
                children: /* @__PURE__ */ jsx(
                  Slider,
                  {
                    ...
                    navigationTargetElementId: sliderNavigationId,
                    isBeyondTheViewportOnMobileS: true,
                    children: (categoryItems2 == null ? void 0 : categoryItems2.map((categoryItem, index22) => /* @__PURE__ */ createElement(
                      CategoryCard,
                      {
                        ...categoryItem,
                        key: index22
                      }
                    ))) ?? (movieItems == null ? void 0 : movieItems.map((movieItem, index22) => /* @__PURE__ */ createElement(
                      MovieCard,
                      {
                        ...movieItem,
                        key: index22
...
const videoPosterSrc1 = "/assets/images/1.jpg";
const videoPosterSrc2 = "/assets/images/2.jpg";
const videoPosterSrc3 = "/assets/images/3.jpg";
const videoPosterSrc4 = "/assets/images/4.jpg";
const videoPosterSrc5 = "/assets/images/5.jpg";
const seasonItems = [
  {
    title: "Season 01",
    subtitle: "9 Episodes",
    ...
    AccordionGroup,
    {
      ...
      children: seasonItems.map(({ title, subtitle, episodes }, index2) => /* @__PURE__ */ jsx(
        Accordion,
        {
          ...
          isOpen: index2 === 0,
          isArrowButton: true,
          children: /* @__PURE__ */ jsx("ul", { className: "seasons__list", children: episodes.map((episode, index22) => /* @__PURE__ */ jsx("li", { className: "seasons__item", children: /* @__PURE__ */ jsx(
            EpisodeCard,
            {
              ...episode
            }
...
const Specifications = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx("dl", { className: "specifications__list", children: items.map(({ key, value, isWide }, index2) => /* @__PURE__ */ jsxs(
        "div",
        {
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "support__body", children: [
          ...
          /* @__PURE__ */ jsx(Image, { className: "support__image", src: "/src/assets/images/support/1.png" })
        ] }),
        /* @__PURE__ */ jsxs(
          "form",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(
                Field,
                {
                  ...
                  inputMode: "tel",
                  mask: "(000) 000 00-00",
                  renderBefore: (buttonClassName) => /* @__PURE__ */ jsx(
                    Select,
                    {
