...
const rooеSelector = '[data-js-select]'
...
class Select extends BaseComponent {
  ...
  fixDropdownPosition = () => {
    ...
    const isButtonOnTheLeftViewportSide = buttonCentreX < viewportCentreX
...
class SelectCollection {
  ...
  init() {
    document.querySelectorAll(rooеSelector).forEach((element) => {
      new Select(element)
    })
  }
}
